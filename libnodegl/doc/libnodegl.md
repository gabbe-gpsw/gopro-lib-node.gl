...
`as_image` |  |  | [`bool`](#parameter-types) | flag this resource for image accessing (texture nodes only) | `0`
`writable` |  |  | [`bool`](#parameter-types) | flag this resource as writable in the shader | `0`
`variadic` |  |  | [`bool`](#parameter-types) | flag this resource as variadic (blocks only) | `0`
