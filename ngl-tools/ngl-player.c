...
static struct ngl_node *get_scene(const char *filename)
{
    ...
    struct ngl_node *var_tex0_coord = ngl_node_create(NGL_NODE_IOVARIABLE, "vec2");
    ...
    ngl_node_param_set(program, "vert2frag_vars", "var_tex0_coord", var_tex0_coord);
    ...
    ngl_node_param_set(render, "fragment_resources", "tex0",           texture);
    ngl_node_param_set(render, "fragment_resources", "media_duration", u_media_duration);
    ngl_node_param_set(render, "fragment_resources", "ar",             u_ar);
    ngl_node_param_set(render, "fragment_resources", "opacity",        u_opacity);
